    ...
    @if(!$isEdit)
        <div class="row hidden meo_client_services_form" id="meo_client_services_form">
            ...
            <div class="form-group col-lg-4" id="service-descriptions">
                ...
                {{ Form::textarea('descriptions[]', null, array('class' => 'form-control', 'size' => '1x5', 'id' => 'service-description')) }}
            </div>
        ...
        @foreach($services as $key=>$service)
            <div class="row hidden meo_client_services_form" id="meo_client_services_form">
                ...
                <div class="form-group col-lg-4" id="service-descriptions">
                    ...
                    {{ Form::textarea('descriptions[]', $service->description, array('class' => 'form-control', 'size' => '1x5', 'id' => 'service-description')) }}
                </div>
                <div class="form-group col-lg-4" id="service-payments">
