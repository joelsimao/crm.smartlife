<div class="row collab_info_form">
    <div class="form-group col-lg-6">
        ...
        <div class="form-group col-lg-8">
            ...
            <div class="input-group date datepicker" data-provide="datepicker">
                {{ Form::text('client[birth_date]', null, array('class' => 'form-control')) }}
        ...
        <div class="form-group col-lg-12">
            ...
            {{ Form::text('collaborator[email]', null, array('class' => 'form-control')) }}
        </div>
        <div class="form-group col-lg-12">
        ...
        <div class="form-group col-lg-8">
            <label for="client[bi_emmission_date]">Data de Emissão BI:</label>
            <div class="input-group date datepicker" data-provide="datepicker">
                {{ Form::text('client[bi_emmission_date]', null, array('class' => 'form-control')) }}
                <div class="input-group-addon">
                    <span class="glyphicon glyphicon-th"></span>
                </div>
            </div>
    ...
    <div class="form-group col-lg-6">
        <div class="form-group col-lg-12">
            ...
            {{ Form::text('collaborator[name]', null, array('class' => 'form-control'))}}
        </div>
        <div class="form-group col-lg-12">
        ...
        <div class="form-group col-lg-8">
            ...
            {{ Form::text('collaborator[bi_number]',null, array('class' => 'form-control ')) }}
        </div>
        <div class="form-group col-lg-4">
            <label for="collaborator[bi_code]">Dig. Contr.:</label>
            {{ Form::text('collaborator[bi_code]',null, array('class' => 'form-control ')) }}
        </div>
        <div class="form-group col-lg-8">
